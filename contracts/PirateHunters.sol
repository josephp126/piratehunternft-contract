...
contract PirateHunters is ERC721, Ownable {
    ...
    function mintX(uint256 _amount, bool _stake) private {
        require(tx.origin == msg.sender, "Only EOA");
        require(
            tokensMinted + _amount <= MAX_TOKENS,
            "Would exceed total supply of available tokens"
        );
    ...
    function setPrice(uint256 _weiPrice) external onlyOwner {
        price = _weiPrice;
    }
